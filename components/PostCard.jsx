...
const PostCard = ({ post }) => (
    <div className="bg-post-card shadow-sp1 backdrop-blur-sm rounded-lg p-0 lg:p8 pb-6 sm:pb-12 mb-4 sm:mb-8">
        ...
        <h1 className='transition duration-700 hover:text-pink-600  text-center mb-4 sm:mb-8 cursor-pointer  text-2xl sm:text-3xl  font-semibold'>
            <Link href={`/post/${post.slug}`}>
                {post.title}
            </Link>
        </h1>
        <div className=' flex text-center items-center justify-center mb-4 sm:mb-8 w-full'>
            <div className='flex items-center justify-center w-auto mr-4 sm:mr-8'>
                ...
                />
                <p className='inline align-middle text-gray-700 mr-2 text-lg'>{post.author.name}</p>
            </div>
        ...
        <p className='text-center text-lg text-gray-700 font-normal px-4 lg:px-20 mb-4 sm:mb-8'>{post.excerpt}</p>
